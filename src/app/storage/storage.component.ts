...
export class StorageComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    this.showFavoritesSubscription = this.storageService
      .showFavorites()
      .subscribe(status => {
    ...
    this.showDeletesSubscription = this.storageService
      .showDeletes()
      .subscribe(status => {
    ...
    // Added by K
    this.showSearchSubscription = this.storageService
      .showSearch()
      .subscribe(status => {
    ...
    this.notificationService.checkHasChange().subscribe(changed => {
  ...
  getData() {
    ...
    this.dbxConnection
      ...
      .then(spaceInfo => {
        ...
        this.storageSpace = (
          spaceInfo.allocation.allocated /
          1024 /
          1024 /
          1024
        ).toFixed(2);
